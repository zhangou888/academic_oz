...
projects: []
---
Recently, I've prepared/refreshed my old programming talk materials, I found an very interesting and good post from the web.

It gives a lot of good and bad programming examples. I thought it might be worthwhile for me to share here so that people including myself in the future could be benefited from it.

The original post is [here](https://nicercode.github.io/intro/bad-habits.html).

You can fidn the post below.
...
9.	Keep things tidy. Tidy data is a wonderful data manipulation philosophy proposed by the great Hadley Wickham. You can find his paper [here](https://vita.had.co.nz/papers/tidy-data.pdf). In my personal opinion, every data scientist or statistical analyst should read this paper once. 
