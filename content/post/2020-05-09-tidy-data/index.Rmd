...
```{r fig1, out.width='10%', fig.align='center', fig.pos='h', fig.cap='Tidyverse',echo = FALSE}
...
```{r fig2, out.width='50%', fig.align='center', fig.pos='h', fig.cap='data analysis flow',echo = FALSE}
...
```{r fig3, out.width='50%', fig.align='center', fig.pos='h', fig.cap='data analysis flow',echo = FALSE}
...
```{r fig4, out.width='40%', fig.align='center', fig.pos='h', fig.cap='Tools for Tidy data',echo = FALSE}
...
```{r fig5, out.width='40%', fig.align='center', fig.pos='h', fig.cap='data 1',echo = FALSE}
...
```{r fig6, out.width='40%', fig.align='center', fig.pos='h', fig.cap='data 2',echo = FALSE}
...
```{r fig7, out.width='40%', fig.align='center', fig.pos='h', fig.cap='data 3',echo = FALSE}
...
As psychometricians, the data we usually encounter is the traditional measurement testing data. In order to fit the data into the traditional IRT or CTT software (i.e., WINSTEPS), the data structure usually looks like this- 
