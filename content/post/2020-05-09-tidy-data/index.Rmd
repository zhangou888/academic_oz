...
```{r fig8, out.width='30%', fig.align='center', fig.pos='h', fig.cap='measurement data type 1-item score',echo = FALSE}
...
```{r fig9, out.width='30%', fig.align='center', fig.pos='h', fig.cap='measurement data type 1-item responses',echo = FALSE}
