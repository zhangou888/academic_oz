...
```{r fig2, out.width='60%', fig.align='center', fig.pos='h', fig.cap='data analysis flow',echo = FALSE}
...
```{r fig5, out.width='70%', fig.align='center', fig.pos='h', fig.cap='data 1',echo = FALSE}
