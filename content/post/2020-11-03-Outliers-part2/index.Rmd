...
Outlier detection methods can be divided between `univariate methods` and `multivariate methods` that usually for most of the current body of research. In this post, I am going to focus on the `univariate methods` only.
